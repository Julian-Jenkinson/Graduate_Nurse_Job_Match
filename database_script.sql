...
(1014, 1003, 'Clinical Nurse','Royal Canberra Hospital', 'The job involves working in a hospiatal birthing division and tending to paitents who have recently given birth or require asssistance with their infants.', 'This public hospital is run by the state government and well known for its efficient and caring medical attention.' , '$78,000', 'Full-time', 'Yamba Dr, Garran ACT 2605, Australia', 'Canberra','ACT','Metropolitan area', '2024-03-12','apply@humanresources.gov.au','https://metronorth.health.qld.gov.au/rbwh/','Hospital','Public',440,'Yes','Yes','Yes','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','Y','Yes','','Y','Y','','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y'),
