...
(1004, 1002, 'Nurse', "Royal Brisbane and Woman's Hospital", 'The job involves working in a hospiatal birthing division and tending to paitents who have recently given birth or require asssistance with their infants.',  'This public hospital is run by the state government and well known for its efficient and caring medical attention.' , '$37 - $42', 'Contract', 'Butterfield st, herston, QLD, 4006', 'Brisbane','QLD','Metropolitan centre', '2024-03-10','apply@humanresources.gov.au','https://metronorth.health.qld.gov.au/rbwh/','Hospital','Public',870,'Yes','Yes','Yes','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Yes','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y'),
...
(1006, 1003, 'Registered Midwife','Womans and Childrens Hospital', 'The job involves working in a hospiatal birthing division and tending to paitents who have recently given birth or require asssistance with their infants.', 'This public hospital is run by the state government and well known for its efficient and caring medical attention.' , '$68000', 'Casual', '72 King William Rd, North Adelaide SA 5006, Australia', 'Adelaide','SA','Metropolitan Centre', '2024-03-5', 'apply@humanresources.gov.au','https://metronorth.health.qld.gov.au/rbwh/','Hospital','Public',870,'Yes','Yes','Yes','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Yes','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y'),
