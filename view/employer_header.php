    ...
    <header id="employer_header">
        ...
        <nav class="header-nav">
            <ul>
                ...
                if (isset($_SESSION['employer'])) { 
                    ...
                    echo '<li><a href="/Graduate_Nurse_Job_Match/employer">Dashboard</a></li>
                         <li><a href="/Graduate_Nurse_Job_Match/employer/employer_create_listing.php">Create Listing</a></li>';
                } 
                ?>    
            </ul>
        </nav>
        <div class="header-access">
            ...
            if (isset($_SESSION['employer'])) { 
                ...
                echo '<a href="/Graduate_Nurse_Job_Match/employer/employer_logout.php" class="signin-btn signin-btn::after">Log out</a>';
            } else {
                // User is not logged in, display the sign-in link
                echo '<a href="/Graduate_Nurse_Job_Match/employer/employer_login.php" class="signin-btn signin-btn::after">Sign In</a>';
            }
            ?>
            
            <a href="/Graduate_Nurse_Job_Match/home.php" class="employer-site-btn">Graduate Site</a>
        </div>
    </header>
<body>
