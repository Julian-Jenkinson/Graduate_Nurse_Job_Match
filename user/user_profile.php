...
<div class="main-container">
    ...
    <?php if(isset($user['userFName'])): ?>
        ...
        <div>Preferred sector:</div><div><?php echo $user['sectorPref']; ?></div><br>
        ...
        <div>Would you relocate for work?</div><div><?php echo $user['userRelocate']; ?></div><br>
        
        <div>Preferred rural types:</div>    
        <?php echo ($user['userRuralPrefMetro'] === 'Y') ? "metropolitan" : ""; ?><br>
        <?php echo ($user['userRuralPrefRegional'] === 'Y') ? "regional" : ""; ?><br>
        <?php echo ($user['userRuralPrefRural'] === 'Y') ? "rural" : ""; ?><br>
        <?php echo ($user['userRuralPrefRemote'] === 'Y') ? "remote" : ""; ?><br>
            
        <br>
        <div>Staff accommodation required?</div><div><?php echo $user['userStaffAccoms']; ?></div><br>
