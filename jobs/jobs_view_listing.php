...
<div class="content-center">
    ...
    <div>Facility Type: <?php echo htmlspecialchars($job['jobFacilityType']); ?></div><br>
    ...
    $selectedLocalityServices = array_filter($localityServices, function ($value) {
        return $value === 'Y';
    });
    ...
    if (!empty($selectedLocalityServices)) {
        ...
        <table>
            <tr>
                <?php foreach ($selectedLocalityServices as $service => $value): ?>
                    <td><?php echo $service; ?></td>
                    <?php
                    $rowCount++;
                    if ($rowCount % 3 === 0) echo '</tr><tr>';
